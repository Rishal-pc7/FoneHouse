                        ...
                        <FormItem className="space-y-3"><FormControl>
                            <RadioGroup onValueChange={field.onChange} value={field.value} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <FormItem><FormLabel className="cursor-pointer relative"><FormControl><RadioGroupItem value="cod" className="sr-only peer" /></FormControl>
                                    <div className="border border-gray-200 dark:border-zinc-700 rounded-xl py-8 px-4 flex flex-col items-center justify-center gap-3 hover:border-gray-300 transition-all h-full bg-white dark:bg-zinc-900 peer-data-[state=checked]:border-brandBlue peer-data-[state=checked]:border-2 peer-data-[state=checked]:bg-blue-50/50 dark:peer-data-[state=checked]:bg-brandBlue/10 peer-data-[state=checked]:text-brandBlue shadow-sm"><Truck className="w-12 h-12 mb-2" /><span className="font-bold text-lg">Cash on Delivery</span></div>
                                </FormLabel></FormItem>
                                <FormItem><FormLabel className="cursor-pointer relative"><FormControl><RadioGroupItem value="prepaid" className="sr-only peer" /></FormControl>
                                    <div className="border border-gray-200 dark:border-zinc-700 rounded-xl py-8 px-4 flex flex-col items-center justify-center gap-3 hover:border-gray-300 transition-all h-full bg-white dark:bg-zinc-900 peer-data-[state=checked]:border-brandBlue peer-data-[state=checked]:border-2 peer-data-[state=checked]:bg-blue-50/50 dark:peer-data-[state=checked]:bg-brandBlue/10 peer-data-[state=checked]:text-brandBlue shadow-sm"><CreditCard className="w-12 h-12 mb-2" /><span className="font-bold text-lg">Pay Online</span></div>
                                </FormLabel></FormItem>
                            </RadioGroup>
